...
3) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:
...
20) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:
...
23) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:
...
27) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:
...
31) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:
...
`git commit -am 'first passing test'`

35) Driver [Dev A]; Add a new test that forces more interesting behaviour on the part of the application, e.g. 
...
36) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:

37) Driver [Dev B]; Make the minimum possible adjustment to the application (app) code so that the test passes, e.g. 
...
38) Driver [Dev B]; commit the change to the git repository

`git commit -am 'second passing test'`

39) Driver [Dev B]; Add a new test that forces more interesting behaviour on the part of the application, e.g. 
...
40) Switch Driver/Navigator Roles&nbsp;:twisted_rightwards_arrows:

41) Driver [Dev A]; Make the minimum possible adjustment to the application (app) code so that the test passes, e.g. 
...
42) Driver [Dev A]; commit the change to the git repository

`git commit -am 'third passing test'`
